  ...
  return (
    <div className="items-start bg-white flex flex-col">
      ...
      <div className="justify-center items-stretch bg-white self-stretch flex w-full flex-col px-16 py-16 max-md:max-w-full max-md:px-5">
        <div className="justify-center pt-12 md:py-10 max-md:max-w-full max-md:mr-2.5">
          ...
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
            ...
            <div className="flex flex-col items-stretch w-[33%] ml-5 max-md:w-full max-md:ml-0">
              <div className="bg-white flex grow justify-between gap-4 w-full pl-6 pr-16 py-6 rounded-xl items-start max-md:mt-10 max-md:px-5">
                ...
                <div className="items-stretch self-stretch flex grow basis-[0%] flex-col">
                  <p className="text-slate-950 font-bold leading-7 whitespace-nowrap">Formació presencial i online</p>
            ...
            <div className="flex flex-col items-stretch w-[33%] ml-5 max-md:w-full max-md:ml-0">
              <div className="bg-white flex grow justify-between gap-4 w-full pl-6 pr-20 py-6 rounded-xl items-start max-md:mt-10 max-md:px-5">
                ...
                <div className="items-stretch self-stretch flex grow basis-[0%] flex-col">
                  <p className="text-slate-950 font-bold leading-7 whitespace-nowrap">Cursos de tots els nivells</p>
      ...
      {/* FAQ */}
      <div className="justify-center items-center self-stretch bg-slate-100 flex w-full flex-col px-16 py-12 max-md:max-w-full max-md:px-5">
        <div className="flex w-full max-w-[1176px] flex-col mt-6 mb-11 max-md:max-w-full max-md:mb-10">
          ...
          <h2 className="text-blue-950 text-center leading-10 self-center whitespace-nowrap mt-2">Alguna pregunta?</h2>
          <div className="items-stretch self-stretch flex w-full justify-between gap-5 mt-12 pr-16 max-md:max-w-full max-md:flex-wrap max-md:mt-10 max-md:pr-5">
            <div className="bg-white flex justify-between gap-5 pl-9 pr-14 py-10 rounded-xl items-start max-md:max-w-full max-md:flex-wrap max-md:px-5">
              ...
              <div className="items-stretch self-stretch flex grow basis-[0%] flex-col">
                ...
                <p className="text-zinc-800 leading-7 mt-4">Tota persona major de 16 anys i amb DNI, NIE o passaport pot inscriure's a qualsevol activitat de Cibernàrium. No cal estar en cap situació laboral específica (ocupada, en atur, etc.) ni pertànyer a cap sector professional concret.</p>
              </div>
            </div>
            ...
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
              <div className="flex flex-col items-stretch w-3/12 max-md:w-full max-md:ml-0">
                <div className="items-stretch flex flex-col max-md:mt-7">
                  ...
                  />
                  <p className="text-slate-700 font-bold leading-7 mt-3.5">Cibernàrium Nou Barris</p>
              ...
              <div className="flex flex-col items-stretch w-3/12 ml-5 max-md:w-full max-md:ml-0">
                <div className="items-stretch flex flex-col max-md:mt-7">
                  <img
                    ...
                    className="aspect-[1.4] object-contain object-center w-full overflow-hidden"
                  />
                  <p className="text-slate-700 font-bold leading-7 mt-2.5">Online - en directe</p>
              ...
              <div className="flex flex-col items-stretch w-3/12 ml-5 max-md:w-full max-md:ml-0">
                <div className="items-stretch flex flex-col max-md:mt-7">
                  ...
                  <p className="text-slate-700 font-bold leading-7 mt-2.5">Online</p>
                  <div className="text-slate-950 text-lg font-bold leading-8 whitespace-nowrap mt-1">Curs en Big Data</div>
                </div>
              </div>
            </div>
          </div>
