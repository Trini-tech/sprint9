...
export default function CenterCard({ center }: { center: Center }) {
  return (
    <div className="flex flex-col items-start py-3 pr-20 pl-4 mt-4   rounded-xl border border-solid border-[color:var(--Gris-150,#E7E7E9)] max-md:pr-5 max-md:max-w-full">
